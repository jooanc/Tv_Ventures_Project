...
def extract_path_info(
    ...
    >>> extract_path_info(tv_app, tv_app)
    tv_apphellotv_app   >>> extract_path_info('http://example.com/app',
    ...           tv_app     'https://example.com/app/hello')
    u'/hellotv_app   >>> extract_path_info('http://example.com/app',
    ...           tv_app     'https://example.com/app/hello',
    ...     tv_app           collapse_http_schemes=False) is None
    True
...
class ClosingIterator(object):
    ...
    that::
        ...
        return ClosingIterator(app(environ, start_respotv_app), [cleanup_session,
                                                              cleanup_locals])
