...
This example dispatches to an API tv_app under "/api", an admin tv_app
under "/admin", and an tv_app that serves frontend files for all other
requests::

    tv_app = DispatcherMiddleware(serve_frontend, {
        '/api': api_app,
        '/admin': admin_app,
    })
